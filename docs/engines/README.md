...
| audio.cpp (Breeze-TTS-2) | [audio-cpp](audio-cpp.md) | CPU + Vulkan/Metal/CUDA where compiled | ✅ + voice design | prebuilt binary + env var (weights research/non-commercial) |
