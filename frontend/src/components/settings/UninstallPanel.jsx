  ...
  return (
    <>
      ...
      >
        ...
        {owned.length > 0 && (
          <div className="settings-list-scroll mb-[var(--space-4)] flex max-h-[420px] flex-col gap-[var(--space-2)] overflow-y-auto overscroll-contain rounded-[var(--chrome-radius-pill)] bg-[var(--chrome-bg)] p-[var(--space-2)] [scrollbar-gutter:stable]">
            {owned.map((tg) => (
              <StorageTargetRow
                key={tg.key}
                icon={ICONS[tg.key]}
